...
public class Interfaz2 extends javax.swing.JFrame {
    ...
    private void input_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_input_buscarActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_input_buscarActionPerformed

    private void cargar_resumenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cargar_resumenActionPerformed
        String ruta = "";
    ...
    if(res == JFileChooser.APPROVE_OPTION){
        ...
        for (resumen resumenRegistrado : ListaResumenes) {
            ...
            if (tituloRepetido) {
                for (int i = 0; i < ListaResumenes.length; i++) {
                    if (ListaResumenes[i] == null) {
                        ListaResumenes[i] = resumenObj;  
        ...
        try {
            ...
            primera_palabra(ruta);
            intHashCal = tablaHash.calcularHash(primera_palabra(ruta));
...
public void mostrar_tituloarchivo(resumen resumen) {
    ...
    public static String primera_palabra(String fileName) throws IOException {
    ...
    public static void IncluirPalabrasClaves (NodoDoble hPClaves[], String ListaNPalabras, int index)
    {
        ...
        ListaPalabras = ListaNPalabras.split(",");
        for (String Palabra : ListaPalabras)
        {
            tablaHash.insertPClave(hPClaves, Palabra, index);
        }
    
    }//GEN-LAST:event_cargar_resumenActionPerformed

    private void analizar_resumenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_analizar_resumenActionPerformed
    estadisticas();
    }
    ...
    }//GEN-LAST:event_analizar_resumenActionPerformed
...
private void guardarRutasEnHistorial(String[] rutasArchivos) {
    ...
    private void search_pclaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_search_pclaveActionPerformed
      
           for(NodoDoble palabra_a_buscar:hPClaves){
           if (input_buscar.getText().trim().equals(palabra_a_buscar.getData())){
               Lista_resumenes.setText(palabra_a_buscar.getListaAdy().BuscarDataIndice(0).toString()); //no se que posicion es en general
    ...
    }//GEN-LAST:event_search_pclaveActionPerformed
